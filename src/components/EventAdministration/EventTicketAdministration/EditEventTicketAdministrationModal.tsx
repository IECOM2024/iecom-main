...
interface EditEventTicketAdministrationModalProps {
  editEventTicket: (
...
export const EditEventTicketAdministrationModal = ({
  editEventTicket,
  eventList,
  eventTicket,
  deleteEventTicket,
}: EditEventTicketAdministrationModalProps) => {
  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader>Edit Registration Ticket</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
